...
const routePreloaders: Record<string, PreloadableRoute> = {
  ...
  '/dashboard/iff': () => import('../pages/IFF/RIBDashboardPage'),
  '/iff/match-control': () => import('../pages/IFF/RIBMatchControlPage'),
  '/iff/match-cards-editor': () => import('../pages/IFF/RIBMatchCardsEditorPage'),
  '/iff/unified-overlay': () => import('../pages/IFF/RIBUnifiedOverlay'),
  '/iff/single-match-overlay': () => import('../pages/IFF/RIBSingleMatchOverlay'),
  '/iff/player-stats-overlay': () => import('../pages/IFF/RIBPlayerStatsOverlay'),
  '/iff/part-one-overlay': () => import('../pages/IFF/RIBPartOneOverlay'),
  '/iff/stream-overlay': () => import('../pages/IFF/RIBStreamOverlay'),
