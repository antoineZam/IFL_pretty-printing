  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        'archivo-black-italic': ['Archivo Black Italic', 'sans-serif'],
        'archivo-condensed': ['Archivo Condensed Regular', 'sans-serif'],
        'archivo-condensed-bold': ['Archivo Condensed Bold', 'sans-serif'],
        'archivo-condensed-black': ['Archivo Condensed Black', 'sans-serif'],
        'archivo-condensed-black-italic': ['Archivo Condensed Black Italic', 'sans-serif'],
        'archivo-expanded-regular': ['Archivo Expanded Regular', 'sans-serif'],
        'archivo-expanded-bold': ['Archivo Expanded Bold', 'sans-serif'],
        'archivo-expanded-bold-italic': ['Archivo Expanded Bold Italic', 'sans-serif'],
        'archivo-expanded-black-italic': ['Archivo Expanded Black Italic', 'sans-serif'],
        'archivo-condensed-italic': ['Archivo Condensed Italic', 'sans-serif'],
        'archivo-expanded-black': ['Archivo Expanded Black', 'sans-serif'],
        'archivo-semi-condensed-bold': ['Archivo Semi Condensed Bold', 'sans-serif'],
        ...
        'archivo-extra-condensed-medium': ['Archivo Extra Condensed Medium', 'sans-serif'],
